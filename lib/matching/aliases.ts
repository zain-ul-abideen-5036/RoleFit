...
export const SKILL_DEFINITIONS: readonly SkillDefinition[] = [
  ...
  { canonical: 'matlab', label: 'MATLAB', aliases: [], category: 'language' },
  {
    canonical: 'bash',
    label: 'Bash',
    aliases: ['shell scripting', 'shell', 'zsh'],
    category: 'language',
  },
  ...
  },
  {
    canonical: 'dotnet',
    label: '.NET',
    aliases: ['dotnetcore', 'aspnet', 'aspnetcore', 'net core'],
    implies: ['csharp'],
    category: 'framework',
  },
  {
  ...
  },
  {
    canonical: 'sqlserver',
    label: 'SQL Server',
    aliases: ['mssql', 'microsoft sql server', 'sql server'],
    implies: ['sql'],
    category: 'database',
  },
  {
    ...
    aliases: ['oracle db', 'oracle database', 'plsql', 'pl sql'],
    implies: ['sql'],
    category: 'database',
  },
  ...
  },
  {
    ...
    aliases: ['cloud computing', 'cloud platforms'],
    category: 'cloud',
  },
  {
    canonical: 'lambda',
  ...
  },
  {
    canonical: 'git',
    label: 'Git',
    aliases: ['version control', 'github', 'gitlab', 'bitbucket'],
    category: 'devops',
  },
  ...
  },
  {
    ...
    label: 'Observability',
    aliases: ['monitoring', 'monitoring and alerting'],
    category: 'devops',
  },
  ...
  {
    canonical: 'scikitlearn',
    label: 'scikit-learn',
    aliases: ['sklearn', 'scikit learn'],
    implies: ['machinelearning', 'python'],
    category: 'data',
  },
  ...
  },
  {
    ...
    related: ['dataengineering'],
    category: 'data',
  },
  { canonical: 'kafka', label: 'Apache Kafka', aliases: ['apache kafka'], category: 'data' },
  {
    canonical: 'dataengineering',
    label: 'Data Engineering',
    aliases: ['data engineering', 'etl', 'elt', 'data pipelines'],
    category: 'data',
  },
  {
    canonical: 'datavisualization',
    label: 'Data Visualization',
    aliases: ['data visualization', 'data visualisation', 'dataviz'],
    category: 'data',
  },
  {
    canonical: 'tableau',
  ...
  },
  {
    ...
    aliases: ['large language models', 'llms', 'generative ai', 'genai'],
    implies: ['machinelearning'],
    category: 'data',
  },
  ...
  },
  {
    canonical: 'uidesign',
    label: 'UI Design',
    aliases: ['ui', 'user interface design'],
    category: 'design',
  },
  {
    canonical: 'designsystems',
    label: 'Design Systems',
    aliases: ['design system'],
    category: 'design',
  },
  {
    canonical: 'userresearch',
    label: 'User Research',
  ...
  // --------------------------------------------------------------- product
  {
    canonical: 'productmanagement',
    label: 'Product Management',
    aliases: ['product management', 'product strategy'],
    category: 'product',
  },
  {
    canonical: 'roadmapping',
    label: 'Roadmapping',
    aliases: ['product roadmap', 'roadmap planning'],
    category: 'product',
  },
  {
    canonical: 'stakeholdermanagement',
    label: 'Stakeholder Management',
    aliases: ['stakeholder management', 'stakeholder engagement'],
    category: 'product',
  },
  {
    canonical: 'abtesting',
  ...
  },
  {
    ...
    aliases: ['product analytics', 'google analytics', 'mixpanel', 'amplitude'],
    category: 'product',
  },
  ...
  { canonical: 'kanban', label: 'Kanban', aliases: [], implies: ['agile'], category: 'practice' },
  {
    canonical: 'testing',
    label: 'Testing',
    aliases: ['unit testing', 'automated testing', 'test automation'],
    category: 'practice',
  },
  {
    canonical: 'tdd',
  ...
  {
    canonical: 'codereview',
    label: 'Code Review',
    aliases: ['code reviews', 'peer review'],
    category: 'practice',
  },
  {
  ...
  },
  {
    canonical: 'security',
    label: 'Security',
    aliases: ['application security', 'appsec', 'cybersecurity'],
    category: 'practice',
  },
  {
    canonical: 'mentoring',
  ...
  },
  {
    ...
    label: 'Collaboration',
    aliases: ['cross functional collaboration', 'teamwork'],
    category: 'practice',
  },
] as const
